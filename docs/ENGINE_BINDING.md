...
B1 introduced the lifecycle binding; B2 now pins connectcore v0.6.2 and uses
...
connectcore v0.6.2 exposes its deterministic network/probe seams only to its own
